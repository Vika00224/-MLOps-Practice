...
def data_preparation(path):
    ...
    data = df.drop('Recurred', axis=1)  # удаляем целевую переменную
    ...
    df_prep = pd.concat([data_st, df['Recurred']], axis=1)  # объединяем стандартизованные данные и целевую переменную
    return df_prep